...
export const services = [
  {
    ...
    icon: Fuel, title: 'Fuel Station Construction', tag: 'EPC',
    desc: 'End-to-end EPC delivery of petrol pumps and retail fuel outlets for HPCL, IOCL, BPCL and private operators.',
    img: IMG.refinery3,
  ...
  {
    slug: 'oil-gas-infrastructure',
    icon: Waves, title: 'Oil & Gas Infrastructure', tag: 'Energy',
    desc: 'Design and installation of tank farms, pipelines, terminals and refinery utility systems.',
    img: IMG.refinery1,
    hero: IMG.refinery1,
  ...
  },
  {
    ...
    icon: Factory, title: 'Industrial Construction', tag: 'Industrial',
    desc: 'Turnkey construction of factories, warehouses and heavy industrial facilities.',
    img: IMG.industry1,
    hero: IMG.industry1,
    overview: 'Greenfield and brownfield industrial construction across steel, cement, chemicals, pharma, FMCG and general manufacturing sectors. From pre-engineered buildings to complex process plants — delivered end-to-end.',
    capabilities: [
      'PEB structures & heavy industrial sheds',
      'RCC framed structures for multi-storey plants',
      'MEP, HVAC, compressed air & process piping',
      'ETP / STP, utility yards, cooling towers',
      'Plant expansions & shutdown execution',
      'Cleanrooms, GMP-compliant pharma facilities',
    ],
    deliverables: [
      { k: '₹15–300 Cr', v: 'Typical project size' },
      { k: '2–24 months', v: 'Delivery window' },
      { k: '110+', v: 'Industrial plants' },
      { k: 'Turnkey', v: 'Single-window EPC' },
    ],
  },
  {
    slug: 'civil-engineering',
    icon: HardHat, title: 'Civil Engineering', tag: 'Civil',
    desc: 'Structural design and civil execution for high-load industrial and commercial complexes.',
    img: IMG.about,
    hero: IMG.about,
  ...
  },
  {
    ...
    icon: Route, title: 'Road Construction', tag: 'Highways',
    desc: 'National highway, state road and internal-road construction with modern paving technology.',
    img: IMG.bridge2,
    hero: IMG.bridge2,
  ...
  },
  {
    ...
    icon: Landmark, title: 'Bridge Construction', tag: 'Bridges',
    desc: 'Cable-stayed, girder and cantilever bridges engineered for decades of service.',
    img: IMG.bridge1,
    hero: IMG.bridge1,
    overview: 'Complex bridge structures — from river bridges and grade separators to iconic cable-stayed and extradosed bridges. Our bridge division includes specialist launching gantries, form travellers and heavy-lift cranes.',
    capabilities: [
      'Segmental & precast girder bridges',
      'Cable-stayed & extradosed bridges',
      'Well & pile foundations in river beds',
      'Balanced-cantilever construction',
      'Bridge rehabilitation & strengthening',
      'Launching gantries & form travellers in-house',
    ],
    deliverables: [
      { k: '₹50–500 Cr', v: 'Typical project size' },
      { k: '32', v: 'Bridges delivered' },
      { k: '820 m', v: 'Longest span built' },
      { k: 'IRC:112', v: 'Design code' },
    ],
  },
  {
    slug: 'heavy-machinery',
    icon: Truck, title: 'Heavy Machinery', tag: 'Equipment',
    desc: 'Fleet of cranes, excavators, pavers and rigs backed by certified operators.',
    img: IMG.machine1,
    hero: IMG.machine1,
  ...
  },
  {
    ...
    icon: PackageCheck, title: 'Equipment Supply', tag: 'Supply',
    desc: 'Sourcing and supply of industrial equipment, fittings and specialised components.',
    img: IMG.machine2,
    hero: IMG.machine2,
    overview: 'Vendor consolidation and equipment supply for construction and industrial clients — from a single specialised valve to complete plant utility packages. Direct relationships with 400+ Indian and global OEMs.',
    capabilities: [
      'Structural steel, rebar & fabrication supply',
      'Fuel dispensers, tanks & retail equipment',
      'Industrial pumps, valves, compressors',
      'HVAC, ETP / STP process equipment',
      'Electrical panels, transformers, cabling',
      'Global sourcing & customs clearance',
    ],
    deliverables: [
      { k: '400+', v: 'OEM partners' },
      { k: 'Global', v: 'Sourcing network' },
      { k: '15%', v: 'Avg cost saving' },
      { k: 'Turnkey', v: 'BOQ to delivery' },
    ],
  },
  {
    slug: 'infrastructure-development',
    icon: Building2, title: 'Infrastructure Development', tag: 'Infra',
    desc: 'Master-planned public and private infrastructure — utilities, drainage, roads and lighting.',
    img: IMG.industry2,
    hero: IMG.industry2,
  ...
  {
    slug: 'epc-projects',
    icon: Cog, title: 'EPC Projects', tag: 'Turnkey',
    desc: 'Engineering, procurement and construction on a single-window turnkey basis.',
    img: IMG.refinery2,
    hero: IMG.refinery2,
    overview: 'Full-scope EPC on lump-sum or item-rate basis. Arroyo takes single-point responsibility from FEED to commissioning — engineering design, global procurement, on-site construction, testing and handover.',
    capabilities: [
      'FEED & detailed engineering',
      'Procurement & vendor management',
      'Construction, testing, commissioning',
      'Lump-sum / EPCM / EPCC contracts',
      'PMO reporting & milestone dashboards',
      'Post-handover O&M packages',
    ],
    deliverables: [
      { k: '₹50–500 Cr', v: 'Typical EPC size' },
      { k: '1', v: 'Point of accountability' },
      { k: '95%', v: 'On-time delivery rate' },
      { k: 'ISO', v: 'PMO framework' },
    ],
  },
];
