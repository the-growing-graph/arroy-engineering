...
export const services = [
  {
    ...
    icon: Truck, title: 'Machinery, Equipments', tag: 'Fleet',
  ...
  {
    slug: 'infrastructure',
    icon: Building2, title: 'Infrastructure', tag: 'Infra',
  ...
  {
    slug: 'fuel-station',
    icon: Fuel, title: 'Fuel Station', tag: 'EPC',
    desc: 'Lump-sum turnkey EPC projects of petrol pumps and retail outlets for PSU and private fuel companies.',
    img: IMG.refinery3,
    hero: 'https://images.unsplash.com/photo-1545262810-77515befe149?auto=format&fit=crop&w=2400&q=80',
  ...
  {
    slug: 'oil-gas',
    icon: Waves, title: 'Oil & Gas', tag: 'Energy',
  ...
  {
    slug: 'construction',
    icon: HardHat, title: 'Construction', tag: 'Structural',
  ...
  {
    slug: 'road-sectors',
    icon: Route, title: 'Road Sectors', tag: 'Highways',
